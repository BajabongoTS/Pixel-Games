...
void View_of_fight() {
    ...
    cout << R"(             __________________________________________________________________________________________________________________________________________________________________________________________)" << endl;
    cout << R"(            /  \   Enemy Stats       EnemyDamage: )" << EndmyDamage << "                                                   |   Your Stats       PlayerDamege: " << PlayerDamage << "                                                                \." << endl;
    cout << R"(           |   |                                        Hp:                                            |                         Hp:                                         Mana:                     |.
            \__|                           +--------------------------+                                |                +---------------------+                      +---------------------+           |.)" << endl;
    cout << "               |                           |###########" << EnemyHp << "############|                                |                |#########" << hp << "#########|                      |#########" << mana << "#########|           |." << endl;
    cout << R"(               |                           +--------------------------+                                |                +---------------------+                      +---------------------+           |.
